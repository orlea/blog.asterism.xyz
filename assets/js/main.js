...
window.onload = function () {
  ...
  // 参考 https://github.com/ingorichter/hugo-future-imperfect-slim/commits/master/assets/js/main.js
  var lang = document.documentElement.lang;
  var pathArgs = [document.location.origin];
  pathArgs.push("index.json");
